...
namespace GEMBibleBooks.Helpers
{

    public class FileStorage
    {
        private readonly LocalRootFolder appBasefolder;
        ...
        private FileStorage()
        {
            appBasefolder = new LocalRootFolder();
        ...
        public async Task<T> GetObjectFromFile<T>(string jsonFileName)
        {
            ...
            var jsonInFileStream = await jsonFile.OpenAsync(PCLExt.FileStorage.FileAccess.Read);
        ...
        public async Task SaveObjectToFile(string jsonFileName, object objectToWrite)
        {
            ...
            var jsonStream = await jsonFile.OpenAsync(PCLExt.FileStorage.FileAccess.ReadAndWrite);
        ...
        public async Task ExtractZipFile(string archiveFilenameIn, string outFolder)
        {
            ...
            var fs = await inFile.OpenAsync(PCLExt.FileStorage.FileAccess.Read);
        ...
        public async Task ExtractZipFileFromStream(Stream fs, string outFolder)
        {
            ...
            try
            {
                ...
                foreach (ZipEntry zipEntry in zf)
                {
                    ...
                    using (var streamWriter = await outFile.OpenAsync(PCLExt.FileStorage.FileAccess.ReadAndWrite))
                    {
        ...
        public async Task CreateNewZipFile(string path)
        {
            ...
            zipOutFileStream = await zipOutFile.OpenAsync(PCLExt.FileStorage.FileAccess.ReadAndWrite);
        ...
        public async Task<Stream> GetFileStreamFromZip(string zipFilePath, string pathInZip)
        {
            ...
            var zipInFileStream = await zipInFile.OpenAsync(PCLExt.FileStorage.FileAccess.Read);
